      ...
      <div className="space-y-10">
        ...
        <Section className="space-y-4">
          ...
          <p className="max-w-2xl text-base text-slate-700 sm:text-lg">
            Instalación, mantenimiento y solución de problemas de aire acondicionado y bombas
            de calor. Vamos a domicilio en Madrid y Barcelona y te ayudamos a conseguir
            confort sin disparar el consumo.
          </p>
        ...
        <Section className="space-y-4">
          ...
          <p className="max-w-3xl text-sm text-slate-700 sm:text-base">
            Trabajamos con un enfoque práctico: primero entendemos el espacio, el uso y el
            problema real, y luego proponemos una solución que tenga sentido (técnicamente y
            en consumo).
          </p>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <Card>
              ...
              <CardText>
                Limpieza, revisión y ajustes para que el equipo rinda mejor, haga menos ruido
                y consuma menos. Ideal antes de verano o invierno.
              </CardText>
            </Card>
            ...
            <Card>
              ...
              <CardText>
                Si toca cambiar el equipo o instalar uno nuevo, te orientamos en potencia y
                uso para no sobredimensionar ni quedarte corto.
              </CardText>
            </Card>
            ...
            <Card>
              ...
              <CardText>
                No enfría, no calienta, gotea, hace hielo, huele mal o salta el diferencial:
                revisamos, diagnosticamos y te proponemos el arreglo.
              </CardText>
            </Card>
          </div>
        </Section>
        ...
        <Section className="rounded-2xl border border-slate-200 bg-slate-900 p-5 text-slate-50 sm:p-6">
          ...
          <p className="text-sm text-slate-100 sm:text-base">
            Cuando un equipo falla en pleno calor o en días fríos, entendemos la urgencia.
            Damos prioridad a estos casos con tiempos realistas: en Barcelona, siempre que
            haya técnico disponible, buscamos atender en menos de 4 horas. En Madrid y en el
            resto de casos, te damos una estimación clara y agendamos lo antes posible.
          </p>
        </Section>
        ...
        <Section className="space-y-4">
          ...
          <div className="grid gap-4 lg:grid-cols-3">
            <Card className="shadow-none">
              ...
              <CardText>
                Sí. Trabajamos con sistemas de climatización para frío y calor y te orientamos
                según el uso real del espacio.
              </CardText>
            </Card>
            ...
            <Card className="shadow-none">
              ...
              <CardText>
                Depende del uso, pero suele ser buena idea revisar antes de la temporada fuerte
                (verano/invierno) para evitar fallos cuando más lo necesitas.
              </CardText>
            </Card>
            ...
            <Card className="shadow-none">
              ...
              <CardText>
                Sí, trabajamos a domicilio en ambas ciudades y alrededores. Si nos dices tu zona
                por teléfono, te confirmamos disponibilidad y tiempo estimado.
              </CardText>
            </Card>
          </div>
        </Section>
        ...
        <Section className="rounded-2xl border border-dashed border-orange-300 bg-orange-50 p-5 sm:p-6">
          ...
          <p className="max-w-3xl text-sm text-slate-700 sm:text-base">
            Llámanos y cuéntanos qué equipo tienes y qué notas. Si puedes, prepara marca/modelo
            y una foto del equipo para ayudarte mejor.
          </p>
